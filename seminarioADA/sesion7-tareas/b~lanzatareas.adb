pragma Source_File_Name (Ada_Main, Spec_File_Name => "b~lanzatareas.ads");
pragma Source_File_Name (Ada_Main, Body_File_Name => "b~lanzatareas.adb");
...
package body Ada_Main is
   ...
   is
      ...
      pragma Import (Ada, Ada_Main_Program, "_ada_lanzatareas");
